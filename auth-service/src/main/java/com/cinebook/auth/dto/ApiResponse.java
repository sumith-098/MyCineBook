...
/** Generic { success, message, data } envelope so the React side has one predictable shape. */
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> ok(String message) { return new ApiResponse<>(true, message, null); }
